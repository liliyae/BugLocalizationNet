...
logging.basicConfig(level=logging.INFO,
                    ...
                    datefmt='%Y-%m-%d %H:%M:%S')
logger = logging.getLogger('fbl-ranking')
...
def parse_args():
    ...
    parser.add_argument('--checkpoint', dest='checkpoint',
                        default='../../../data/zxing/model_FBLBERT_zxing_RN_bertoverflow_QARCL_q256_d230_dim128_cosine_commits')
    ...
    parser.add_argument('--index_name', dest='index_name',
                        default='INDEX_FBLBERT_RN_bertoverflow_QARCL_q256_d230_dim128_cosine_q256_d230_dim128_commits_token')
