...
logging.basicConfig(level=logging.INFO,
                    ...
                    datefmt='%Y-%m-%d %H:%M:%S')
logger = logging.getLogger('fbl-indexer')
...
def load_colbert(args, device):
    ...
    if os.path.exists(args.checkpoint):
        ...
        model = FblBERT(config, token_config, dev=device, query_maxlen=args.query_maxlen, doc_maxlen=args.doc_maxlen,
